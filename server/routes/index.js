...
import publicPackageRoutes from "./publicPackageRoutes.js";

const router = express.Router();
router.use("/integrations", integrationRoutes);
router.use("/packages", publicPackageRoutes);
