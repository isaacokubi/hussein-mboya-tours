...
const etimsSubmissionSchema = new firestore.Schema({
  ...
  documentId: { type: firestore.Schema.Types.ObjectId, required: true, index: true },
  ...
  response: { type: firestore.Schema.Types.Mixed, default: {} },
...
export default firestore.models.EtimsSubmission || firestore.model("EtimsSubmission", etimsSubmissionSchema);
