...
const privacyRequestSchema = new firestore.Schema({
  ...
  customer: { type: firestore.Schema.Types.ObjectId, ref: "Customer", default: null, index: true },
  ...
  assignedTo: { type: firestore.Schema.Types.ObjectId, ref: "User", default: null },
...
export default firestore.models.PrivacyRequest || firestore.model("PrivacyRequest", privacyRequestSchema);
