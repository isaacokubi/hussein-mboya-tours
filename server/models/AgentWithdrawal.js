...
const agentWithdrawalSchema = new mongoose.Schema(
  {
    ...
    conversationId: { type: String, trim: true, default: "", index: true },
    originatorConversationId: { type: String, trim: true, default: "", index: true },
    resultCode: { type: Number, default: null },
    resultDescription: { type: String, trim: true, default: "" },
