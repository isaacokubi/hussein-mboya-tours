...
const AirportTransferBookingSchema = new Schema({
  ...
  flightArrivalDateTime: { type: Date, default: null },
  flightDepartureDateTime: { type: Date, default: null },
  meetAndGreet: { type: Boolean, default: true },
  signboardName: { type: String, trim: true, maxlength: 180, default: "" },
  whatsappContact: { type: String, trim: true, maxlength: 40, default: "" },
  childSeats: { type: Number, min: 0, default: 0 },
  boosterSeats: { type: Number, min: 0, default: 0 },
  wheelchairAccessible: { type: Boolean, default: false },
  accommodationName: { type: String, trim: true, maxlength: 240, default: "" },
...
export default firestore.models.AirportTransferBooking || firestore.model("AirportTransferBooking", AirportTransferBookingSchema);
