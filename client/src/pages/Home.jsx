  ...
  return (
    <main className="overflow-hidden bg-gray-50">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        <section className="py-12 md:py-16"><StatsSection /></section>
        <section className="py-12 md:py-16"><FeaturedTours /></section>
        <section className="py-12 md:py-16"><DestinationsSection /></section>
        <section className="py-12 md:py-16"><CategoriesSection /></section>
        ...
        <section className="py-12 md:py-16"><TestimonialsSection /></section>
        <section className="py-12 md:py-16"><GallerySection /></section>
        <section className="py-12 md:py-16"><WhyChooseUs /></section>
      </div>
      <section className="mt-8 bg-gradient-to-r from-green-900 via-green-800 to-emerald-700"><MpesaCTA /></section>
      <section className="px-4 sm:px-6 md:px-8 lg:px-12 py-12 max-w-[1600px] mx-auto"><NewsletterSection /></section>
    </main>
  );
}
