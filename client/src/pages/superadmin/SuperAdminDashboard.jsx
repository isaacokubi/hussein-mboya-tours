...
const cards = [
  ["users", "All Platform User Accounts"], ["customers", "Customer Profiles"], ["staff", "Staff"],
...
export default function SuperAdminDashboard() {
  ...
  return <main className="min-h-screen space-y-8 bg-gray-50 p-6 md:p-8">
    ...
    <section className="rounded-2xl border bg-white p-5 text-sm text-gray-500 shadow-sm">Customer Profiles, staff, agents, vehicles, tours, destinations, bookings, and payments shown above are restricted to operational tenant data. The global platform owner account is excluded from tenant-level totals.</section>
