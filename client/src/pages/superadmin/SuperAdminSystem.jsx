  ...
  return <div className="min-h-full bg-slate-50 p-6 lg:p-8">
    <div className="mx-auto max-w-[1600px] space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <MetricCard icon={Database} label="Database" value={databaseHealthy ? "Connected" : "Disconnected"} detail={databaseHealthy ? "Firebase Firestore connection ready" : "Database connectivity requires attention"} tone={databaseHealthy ? "blue" : "amber"} />
