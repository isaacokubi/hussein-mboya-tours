...
import { LayoutDashboard, Map, CalendarCheck, Wallet, Users, Car, Settings, Smartphone, FileText, Home, Shield, BarChart3, UserRoundCog, PackageCheck, Receipt, BookOpen, Code2, UserCheck } from "lucide-react";
...
const sections = [
  ...
  { title: "Governance", items: [["Compliance & eTIMS", "/admin/compliance", Shield, "finance.view"], ["Privacy requests", "/admin/privacy-requests", UserCheck, "finance.view"], ["Developer Platform", "/admin/platform-architecture", Code2, "settings.manage"], ["Staff & Users", "/admin/staff", UserRoundCog, "staff.manage"], ["Roles & Permissions", "/admin/rbac", Shield, "roles.manage"], ["Settings", "/admin/settings", Settings, "settings.manage"], ["Platform Architecture", "/admin/platform-architecture", Shield, "settings.manage"], ["Website", "/", Home, null]] },
];

const ADMIN_CORE_PERMISSIONS = new Set(["admin.dashboard", "booking.manage", "tour.manage", "tour.manage", "customer.view", "staff.manage", "agent.manage", "finance.view", "analytics.view", "roles.manage", "settings.manage"]);
