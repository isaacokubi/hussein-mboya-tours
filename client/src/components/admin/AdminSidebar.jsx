...
export default function AdminSidebar() {
  ...
  const canRender = (permission) => {
    ...
    return (adminUser && ADMIN_CORE_PERMISSIONS.has(permission)) || hasPermission(permission);
  };
  ...
  return (
    <div>
      <div className="ops-brand">
        ...
        <div><div className="ops-brand-title">{companyName}</div><div className="ops-brand-sub">Operations Center</div></div>
      </div>
      ...
      <div className="ops-alert" style={{ marginTop: 20 }}>Operational mode: monitor bookings, payments, schedules, resources, procurement, accounting and compliance from one control surface.</div>
    </div>
  );
}
