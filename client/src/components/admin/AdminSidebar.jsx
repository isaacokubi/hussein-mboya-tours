...
export default function AdminSidebar() {
  ...
  return <div>
    ...
    <div className="ops-alert" style={{marginTop:20}}>Operational mode: monitor bookings, payments, schedules, resources and compliance from one control surface.</div>
  </div>;
}
