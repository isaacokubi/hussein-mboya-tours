...
const sections = [
  ...
  { title: "Governance", items: [["Staff & Users", "/admin/staff", UserRoundCog, "staff.manage"], ["Roles & Permissions", "/admin/rbac", Shield, "roles.manage"], ["Settings", "/admin/settings", Settings, "settings.manage"], ["Platform Architecture", "/admin/platform-architecture", Shield, "settings.manage"], ["Website", "/", Home, null]] },
];
