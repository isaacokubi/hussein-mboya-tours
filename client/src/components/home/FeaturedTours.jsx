...
export default function FeaturedTours() {
  ...
  */
  ...
  if (isLoading) {
    return (
      <section className="py-20 text-center">
        <p className="text-xl font-semibold">Loading tours...</p>
      </section>
    );
  }
  ...
  if (isError) {
    return (
      <section className="py-20 text-center">
        <p className="text-red-600 font-semibold">Failed to load tours.</p>
          ...
          {tourList.map((tour) => (
            ...
            >
              <img
                ...
                alt={tour.title || tour.destination?.name || "Tour"}
                className="
                  h-64
                  w-full
                  object-cover
              ...
              <div className="p-6">
                ...
                {tour.price && (
                  <p className="text-green-600 font-bold text-lg mt-4">
                    ksh.{tour.price.toLocaleString("en-US")}
                  </p>
                )}
